    ...
    <section className="science-section" id="buy-now" style={{ background: 'var(--bg-yellow-light)' }}>
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
        ...
        <div style={{ background: '#ffffff', border: '2px solid var(--brand-green)', borderRadius: '24px', padding: '2rem', textAlign: 'center', boxShadow: 'var(--shadow-card)' }}>
          ...
          <img src="https://res.cloudinary.com/zavohueh/image/upload/devine/products/Honey_Fig.png" style={{ width: '140px', height: '170px', objectFit: 'contain', borderRadius: '12px', marginBottom: '1.5rem' }} alt="Trio Pack" />
          <div style={{ fontFamily: 'var(--font-display)', fontSize: '2.2rem', color: 'var(--brand-green)', marginBottom: '1.5rem' }}>₹599</div>
          <button className="btn-pill btn-pill-outline" style={{ width: '100%' }} onClick={() => onAddToCart && onAddToCart('Devine Signature Gift Trio', 599, 'https://res.cloudinary.com/zavohueh/image/upload/devine/products/Honey_Fig.png', 'trio-3')}>
            ENQUIRE NOW
          </button>
        </div>
        ...
        <div style={{ background: '#ffffff', border: '3px solid var(--brand-green)', boxShadow: '0 12px 35px rgba(0, 135, 61, 0.25)', borderRadius: '24px', padding: '2rem', textAlign: 'center', position: 'relative' }}>
          ...
          <img src="https://res.cloudinary.com/zavohueh/image/upload/devine/products/Honey_Amla.png" style={{ width: '140px', height: '170px', objectFit: 'contain', borderRadius: '12px', marginBottom: '1.5rem' }} alt="Heritage Box" />
          <div style={{ fontFamily: 'var(--font-display)', fontSize: '2.2rem', color: 'var(--brand-green)', marginBottom: '1.5rem' }}>₹1,099</div>
          <button className="btn-pill btn-pill-lime" style={{ width: '100%' }} onClick={() => onAddToCart && onAddToCart('Devine Heritage Organic Box', 1099, 'https://res.cloudinary.com/zavohueh/image/upload/devine/products/Honey_Amla.png', 'sampler-12')}>
            ENQUIRE NOW
          </button>
        </div>
        ...
        <div style={{ background: '#ffffff', border: '2px solid var(--brand-green)', borderRadius: '24px', padding: '2rem', textAlign: 'center', boxShadow: 'var(--shadow-card)' }}>
          ...
          <img src="https://res.cloudinary.com/zavohueh/image/upload/devine/products/Honey_Garlic.png" style={{ width: '140px', height: '170px', objectFit: 'contain', borderRadius: '12px', marginBottom: '1.5rem' }} alt="Family Case" />
          <div style={{ fontFamily: 'var(--font-display)', fontSize: '2.2rem', color: 'var(--brand-green)', marginBottom: '1.5rem' }}>₹1,999</div>
          <button className="btn-pill btn-pill-outline" style={{ width: '100%' }} onClick={() => onAddToCart && onAddToCart('Devine Wholesale Family Case', 1999, 'https://res.cloudinary.com/zavohueh/image/upload/devine/products/Honey_Garlic.png', 'pro-24')}>
            ENQUIRE NOW
          </button>
        </div>
