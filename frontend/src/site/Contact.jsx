...
const ic = { width: 16, height: 16, fill: 'none', stroke: '#23301C', strokeWidth: 2, strokeLinecap: 'round', strokeLinejoin: 'round' };
const PhoneIcon = () => (<svg viewBox="0 0 24 24" {...ic}><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z" /></svg>);
const MailIcon = () => (<svg viewBox="0 0 24 24" {...ic}><rect x="2" y="4" width="20" height="16" rx="2" /><path d="m22 7-10 6L2 7" /></svg>);
const PinIcon = () => (<svg viewBox="0 0 24 24" {...ic}><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>);
const ClockIcon = () => (<svg viewBox="0 0 24 24" {...ic}><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /></svg>);
      ...
      <section className="section-pad">
        <div className="container contact-split">
          <div className="info-card">
            ...
            <div className="info-row"><div className="hx-icon"><PhoneIcon /></div><div><b>Call Us</b><span>{PHONES[0].label}<br />{PHONES[1].label}</span></div></div>
            <div className="info-row"><div className="hx-icon"><MailIcon /></div><div><b>Email Us</b><span><a href="mailto:hello@devine.co.in" style={{ color: 'rgba(245,246,241,0.65)' }}>hello@devine.co.in</a></span></div></div>
            <div className="info-row"><div className="hx-icon"><PinIcon /></div><div><b>Visit Us</b><span>Devine Manufacturing Unit<br />Tamil Nadu, India</span></div></div>
            <div className="info-row"><div className="hx-icon"><ClockIcon /></div><div><b>Working Hours</b><span>Mon – Sat, 9:00 AM – 6:00 PM</span></div></div>
          </div>
